select 
    ...
    case 
        when preferences::jsonb -> 'experiencePreferences' is not null
    ...
    preferences::jsonb -> 'experiencePreferences' ? 'Entertainment' as likes_entertainment,
...
from
    {{ source('public', 'user_preferences') }}