...
outcomes as (
    select
        ...
        coalesce(sv.unique_cards_saved, s.inline_unique_cards_interacted, 0) as unique_cards_saved,
        ...
        coalesce(sv.unique_cards_saved, s.inline_unique_cards_interacted, 0) >= 3 as meets_scr3,
